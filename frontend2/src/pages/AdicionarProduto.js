...
export default function AdicionarProduto() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:5000/pelucias', {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="container" style={{ maxWidth: 600, margin: '40px auto' }}>
      <h2>Adicionar Pelúcia</h2>
      <form onSubmit={handleSubmit} className="formulario">
        <input type="text" placeholder="Nome da Pelúcia" value={nome} onChange={e => setNome(e.target.value)} required />
